...
def test_intersection_4():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--first", 5, "--ipv6", "2001:db8:0:0:0::1"]
    )
    assert result.exit_code == 0
...
def test_intersection_5():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--first", 20, "--timestamps", "11:11:11"]
    )
    assert result.exit_code == 0
...
def test_intersection_7():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--last", 8, "--ipv6", "1:2:3:4:5::8"]
    )
    assert result.exit_code == 0
    assert "L20" in result.stdout
...
def test_intersection_8():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--last", 8, "--timestamps", "12:03:59"]
    )
    assert result.exit_code == 0
...
def test_intersection_9():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--ipv4", "192.168.1.1", "--ipv6", "2001:db8:0:0:0::1"]
    )
    assert result.exit_code == 0
...
def test_intersection_10():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--ipv6", "2001:db8:0:0:0::1", "--timestamps", "11:11:11"]
    )
    assert result.exit_code == 0
...
def test_intersection_11():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--first", 15, "--last", 15, "--ipv4", "172.16.0.1"]
    )
    assert result.exit_code == 0
    assert "L12" in result.stdout
    assert "L1 " not in result.stdout
...
def test_intersection_12():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--last", 14, "--ipv4", "192.168.1.1", "--ipv6", "2001:db8:0::1"]
    )
    assert result.exit_code == 0
    assert "L18" in result.stdout
...
def test_intersection_13():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--ipv4", "192.168.1.1", "--ipv6", "2001:db8:0::1", "--timestamps", "12:03:59"]
    )
    assert result.exit_code == 0    
    assert "L18" in result.stdout
...
def test_intersection_14():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--first", 20, "--last", "20", "--ipv4", "192.168.1.10", "--ipv6", "2001:db8:0::1"]
    )
    assert result.exit_code == 0    
...
def test_intersection_15():
    result = runner.invoke(
        app, ["tests/test_files/intersection.log", "--last", 5, "--ipv4", "192.168.1.1", "--ipv6", "2001:db8:0::1", "--timestamps", "12:03:59"]
    )
    assert result.exit_code == 0    
    assert "L18" in result.stdout
    print(result.stdout)
